    ...
    return (
        <div className="space-y-2">
            <div>
                ...
                <FormDescription>
                    Add an image to your restaurant. This will be displayed on your restaurant's page.
                </FormDescription>
            </div>
            <div className="flex flex-col gap-8 md:w-[50%]">
                {exisitingImageUrl && (<AspectRatio ratio={16 / 9}><img src={exisitingImageUrl} className="rounded-md object-cover h-full w-full" /></AspectRatio>)}
